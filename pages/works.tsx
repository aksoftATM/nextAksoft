    ...
    <div className={styles.works_main}>
      ...
      >
        ...
        <div className={styles.more_info}>
          ...
          >
            <h1 style={{ paddingLeft: "30px" }}>DentApp</h1>
            <div
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              <p style={{ color: "gray" }}>
                ...
                информацию о ваших пациентах: контакты, историю зубов, процедуры
                и даже предпочтения. Никогда больше не теряйте данные или
                забывайте детали. <br /> 📅 Предварительная запись клиентов
                теперь максимально удобна. Ваши пациенты могут выбрать удобное
                для них время и день, и система автоматически учитывает
                доступные слоты. Никакой головной боли с организацией
                расписания! <br /> 📲 Наши уведомления через WhatsApp и SMS
                держат ваших пациентов в курсе. Они получат напоминания о
                предстоящей записи, а также важные сообщения от клиники.
                Коммуникация становится легкой и эффективной. <br /> 📊
                Аналитика и отчеты - это инструмент, который помогает вам
                принимать информированные решения. Вы сможете анализировать
                данные по посещениям, процедурам, доходам и многому другому. Это
                помогает вам улучшить качество обслуживания и оптимизировать
                бизнес-процессы. <br /> 🚀 Мы готовы помочь вашей
                стоматологической клинике взлететь на новый уровень. Ваша
                эффективность, удовлетворенность пациентов и рост бизнеса - вот
                наши главные приоритеты. <br /> 🌟 Откройте двери в будущее
          ...
          <div
            ...
            style={{ display: "flex", flexDirection: "column", gap: "20px" }}
          >
            <h1 style={{ paddingLeft: "30px" }}>Breate of prodiction</h1>
            <div
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              <p style={{ color: "gray" }}>
                ...
                швейном цехе. <br /> 🔌 Связь в режиме реального времени: Наше
                приложение позволяет вам подключиться к вашему производству в
                любой точке мира. Теперь вы можете мониторить статус
                производства, отслеживать ход выполнения заказов и получать
                уведомления о важных событиях – все это в режиме онлайн. <br />{" "}
                📊 Отчетность и аналитика: Применяя передовые аналитические
                инструменты, приложение генерирует подробные отчеты о
                производственной деятельности. Вы сможете оценить эффективность
                каждого сотрудника, контролировать расход материалов, а также
                оптимизировать рабочие процессы для достижения максимальной
                производительности. <br /> 👩‍🔧 Учет рабочего времени:
                Отслеживайте рабочее время сотрудников в режиме реального
                времени. Вы точно узнаете, сколько времени каждый работник
                провел за задачами, повышая точность учета и обеспечивая
          ...
          <div
            ...
            style={{ display: "flex", flexDirection: "column", gap: "20px" }}
          >
            <h1 style={{ paddingLeft: "30px" }}>Cheber</h1>
            <div
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              <p style={{ color: "gray" }}>
                ...
                эру эффективности и удобства. <br /> 🗓️ Никаких сложных
                телефонных звонков или личных визитов больше не нужно. Наше
                приложение позволяет вашим клиентам предварительно записаться на
                услуги прямо из дома или в любом другом удобном месте. Просто
                пара касаний – и вы в списке ожидания. <br /> 📩 С легкостью
                поддерживайте активную связь с вашими клиентами через SMS и
                WhatsApp уведомления. Напоминания о предстоящих записях, акциях
                или специальных предложениях будут доставляться напрямую в их
                карманы. <br /> 📊 Наша мощная аналитика поможет вам лучше
                понять ваш бизнес. Получайте детальные отчеты по активности
                клиентов, анализируйте популярные услуги, оценивайте
                эффективность сотрудников и принимайте обоснованные решения для
                дальнейшего роста. <br /> ⏰ Организуйте свой рабочий день по
