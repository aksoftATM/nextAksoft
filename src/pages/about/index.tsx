  ...
  return (
    <div>
      ...
      >
        ...
        <h4>
          Добро пожаловать в мир инноваций и технологий с компанией Aksoft !{" "}
          <br /> Мы — команда вдохновленных и творческих профессионалов,
          специализирующихся на разработке сайтов, веб-сервисов и мобильных
          приложений. <br />
          Мы знаем, как сделать ваше присутствие в интернете неповторимым и
          эффективным. В мире, где технологии развиваются с невероятной
          скоростью, нам важно обеспечить вас самыми передовыми решениями.
          <br /> Наша молодая и амбициозная команда стоит у истоков инноваций,
          готовая воплощать в жизнь самые смелые идеи. Мы верим, что всякий
          проект — это возможность создать нечто уникальное и полезное для вас и
          ваших клиентов. Наш подход основан на автоматизации. Мы понимаем, что
          ваше время ценно, и поэтому стремимся избавить вас от рутинных и
          повторяющихся задач. Благодаря интеллектуальным технологиям и
          современным методикам разработки, мы создаем продукты, которые не
          только красивы, но и эффективно выполняют свои функции Мы гордимся
          нашими успешными проектами, которые приносят реальные результаты нашим
          клиентам. Благодаря нашим решениям, бизнесы расширяются, клиенты
          находятся легко, а процессы становятся более эффективными. Наше
          стремление к качеству и инновациям позволяет нам оставаться на
          переднем крае технологического прогресса Мы готовы стать вашим
          надежным партнером в мире цифровых решений. Независимо от того, нужен
          ли вам современный сайт, удобное веб-приложение или инновационное
          мобильное приложение, мы готовы воплотить вашу идею в реальность С
          нами ваши возможности неограничены. Давайте вместе создадим будущее, в
          котором технологии работают на вас, а не наоборот. Свяжитесь с нами
          сегодня, и давайте начнем работу над вашим следующим великим проектом!
        </h4>
