  ...
  return (
    <>
      <Head>
        ...
        <title>Aksoft - разработка мобильного приложения и CRM систем Бишкек</title>
      ...
      <main className={styles.main}>
        ...
        <div
          ...
          className="forma"
        >
          <p>"Компания Aksoft предоставляет услуги по разработке высокотехнологичных веб-приложений, 
            сайтов и мобильных приложений. Мы специализируемся на создании индивидуальных программных 
            продуктов, автоматизированных систем и цифровых сервисов для решения бизнес-задач любого масштаба. </p>
           <p>Наш подход основан на гибкости и полной ориентации на потребности заказчика. Мы быстро реагируем 
            на изменение требований, совершенствуем продукты «на лету».</p> 
            <p>Благодаря отлаженным процессам на основе agile-методологий, вы получаете нужный результат быстро 
              и без лишних затрат. Мы специально исключаем бюрократические проволочки, чтобы сконцентрироваться на 
              главном - создании продукта мирового уровня с передовыми технологиями."</p>
        </div>
